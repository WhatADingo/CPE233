...
(0019)                       000  || .ORG 0x00
(0020)                            || 
(0021)                       001  || .equ loop_count = 0x01     ; extend the loop count
...
(0034)  CS-0x016  0x36B01         || 	        MOV  R11, loop_count    ;set outside for loop count
...
(0042)  CS-0x01D  0x36B01         || 	        MOV  R11, loop_count    ;set outside for loop count
...
(0048)  CS-0x021  0x36C01         ||             MOV  R12, loop_count   ;set middle for loop count
(0049)                            || 
(0050)  CS-0x022  0x2CC01  0x022  || mid_for1:   SUB  R12, 0x01
(0051)  CS-0x023  0x36D01         ||             MOV  R13, loop_count   ;set inside for loop count
(0052)                            || 
...
(0071)  CS-0x032  0x36C01         ||             MOV  R12, loop_count ;set middle for loop count
(0072)                            || 
(0073)  CS-0x033  0x2CC01  0x033  || mid_for2:   SUB  R12, 0x01
(0074)  CS-0x034  0x36D01         ||             MOV  R13, loop_count ;set inside for loop count
(0075)                            || 
...
LOOP_COUNT     0x001   (0021)  ||  0034 0042 0048 0051 0071 0074 
